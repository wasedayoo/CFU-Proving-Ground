...
void pg_perf_reset(void) { *(volatile char *)0x40000000UL = 0; }

void pg_perf_enable(void) { *(volatile char *)0x40000000UL = 1; }

void pg_perf_disable(void) { *(volatile char *)0x40000000UL = 2; }
